...
export class PlanFeaturesController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'The plan feature has been successfully created.', type: CreatePlanFeatureDto })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Successfully retrieved all plan features.', type: [CreatePlanFeatureDto] })
  async findAll() {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Plan feature found.', type: CreatePlanFeatureDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Plan feature not found.' })
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'The plan feature has been successfully updated.', type: CreatePlanFeatureDto })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Plan feature not found.' })
  async update(@Param('id') id: string, @Body() updatePlanFeatureDto: UpdatePlanFeatureDto) {
  ...
  @ApiResponse({ status: HttpStatus.NO_CONTENT, description: 'The plan feature has been successfully deleted.' })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Plan feature not found.' })
