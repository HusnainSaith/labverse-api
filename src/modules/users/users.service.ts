...
//       // A much more robust way to get all permissions with their source ('role' or 'direct').
//       // We first join the two permission tables in a subquery and then join that
//       // result to the permissions table. This avoids the syntax error.
//       if (user.role?.id) {
...
//           FROM permissions p
//           INNER JOIN (
//             -- Union of role permissions and direct user permissions
...
//       // We don't need to manually delete the property here.
//       // The `allPermissions` variable is what we care about.
